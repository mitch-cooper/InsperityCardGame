...
namespace InsperityCardGame
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var player1 = new Player(player1Id, "Player 1", "1", ConsoleColor.DarkMagenta, new Deck(player1Id, new List<Card>()
            {
            ...
            var player2 = new Player(player2Id, "Player 2", "2", ConsoleColor.DarkCyan, new Deck(player2Id, new List<Card>()
            {
